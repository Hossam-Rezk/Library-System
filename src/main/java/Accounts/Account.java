...
public abstract class Account implements IdGenerator {
    ...
    protected abstract boolean isIdExists(String id);*/


    /*
    protected abstract void login(String email, String password);
    protected abstract void register(Accounts.Account acc);

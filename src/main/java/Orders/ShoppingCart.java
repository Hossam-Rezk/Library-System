...
public abstract class ShoppingCart {
    List<CartItem> cartItems; // default access modifier cuz inheritance in same package
    ...
    //public abstract void addToCart(Book book, int quantity);

    // over loading addToCart for borrower
    ...
    CartItem findItemInCart(Book book) { //default not private cuz inheritance but it should be private cuz users dont know how others functions work in background behind scenes
    ...
    public abstract void completePurchase(); // process Order / Process transaction
